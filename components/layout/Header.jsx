    ...
    <div className="flex flex-col sm:flex-row items-center justify-between sm:justify-start px-8">
      ...
      <div className="flex flex-col justify-between mt-8 sm:mt-0 sm:h-28 sm:pt-2 sm:pb-3 sm:ml-12">
        ...
        <nav className="flex flex-wrap items-center gap-6 text-sm font-medium">
          ...
          <a id="first-paypal-btn" href="https://paypal.com/us/fundraiser/charity/4897134" target="_blank" className="text-white bg-[#0070ba] hover:brightness-95 focus:ring-4 focus:ring-[#F7BE38]/50 font-medium rounded-full text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#F7BE38]/50">
