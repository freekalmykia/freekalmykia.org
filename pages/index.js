    ...
    <Layout metaTitle="Home">
      <div className="fixed flex items-center bg-kalmyk-yellow top-0 left-0 right-0 pt-1 pb-3 px-1 min-h-[40px]">
        <div className="flex flex-col max-screen-xl px-8 mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-center mb-3">
          ...
          <div className="md:text-center mb-2">
            <p className="mb-1">Include message with your donation:</p>
            <ul className="ml-4">
              <li>&quot;<span className="font-semibold">GP</span>&quot; for General Purposes</li>
              <li>&quot;<span className="font-semibold">KIDS</span>&quot; for Math Class for Children</li>
            </ul>
          </div>
          <div className="md:text-center">
            <Link href="/statistics/donors"><a className="text-blue-600 no-underline hover:underline font-semibold">Our donors</a></Link>
          </div>
        </div>
